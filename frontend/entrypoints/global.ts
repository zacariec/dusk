...
export class SectionId {
  ...
  static parseId(qualifiedSectionId: string): string {
    return qualifiedSectionId.split(SectionId.#separator)[0];
  }

  // for a qualified section id (e.g. 'template--22224696705326__main'), return just the section name (e.g. 'main')
  static parseSectionName(qualifiedSectionId: string): string {
    return qualifiedSectionId.split(SectionId.#separator)[1];
  }

  // for a section id (e.g. 'template--22224696705326') and a section name (e.g. 'recommended-products'), return a qualified section id (e.g. 'template--22224696705326__recommended-products')
  static getIdForSection(sectionId: string, sectionName: string): string {
...
const trapFocusHandlers: { focusin?: (arg0: FocusEvent) => void, focusout?: () => void, keydown?: (arg0: KeyboardEvent) => void } = {};

export function trapFocus(container: HTMLElement | Element, elementToFocus = container): void {
...
export function debounce<T, R>(fn: (...args: T[]) => R, wait: number) {
...
export function throttle<T, R>(fn: (...args: T[]) => R, delay: number): (...args: T[]) => R | undefined | ((...args: T[]) => R) {
  let lastCall = 0;
